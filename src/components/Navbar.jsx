...
function Navbar() {
  return (
    <div className='bg-black h-14 flex items-center px-5 py-2 justify-between'>
      ...
      <div>
        <input type='text' placeholder='search...' className='p-1 text-md outline-none rounded-l-md'></input>
      ...
      <div className='flex gap-4'>
        ...
        <button className='text-white bg-indigo-500 px-4 py-2 rounded-sm'>Cart: </button>
      </div>
    </div>
  )
}
